...
function drop(i){
	...
	i.animate(
		[
		{top : -Math.random()*70+"%", left : '50%'},//Starts in the middle and slightly above. 
		{top: 80+Math.random()*20+'vh', left : Math.random()*95+'%',transform: 'rotate('+(Math.random()*2-1)*360+'deg)' } //Stop at the bottom of div and anywhere left to right. 
